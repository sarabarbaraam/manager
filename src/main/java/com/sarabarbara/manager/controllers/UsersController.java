...
import com.sarabarbara.manager.responses.BaseResponse;
...
import static com.sarabarbara.manager.utils.constants.APIConstants.*;
import static com.sarabarbara.manager.utils.constants.swagger.SwaggerUsersExamplesConstants.*;
...
public class UsersController {
    ...
    @Operation(summary = "Delete an user",
            description = "Delete an user by the username")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "OK",
                    content = @Content(mediaType = APPLICATION_JSON,
                            examples = @ExampleObject(
